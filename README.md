...
| **tracksClusterViewChandges**               | Bool                  | true                                         | Sets whether the cluster markers should track view changes. It's recommended to turn it off whenever it's possible to improve cluster markers performance. |
